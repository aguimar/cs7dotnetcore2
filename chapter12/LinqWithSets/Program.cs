...
namespace LinqWithSets
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Output(cohort2.Intersect(cohort3), "cohort2.Intersec(cohort3): items that are in both sequencess");
            ...
            Output(cohort1.Zip(cohort2, (c1, c2) => $"{c1} matched with {c2}"), "cohort2, (c1, c2) => $\"{c1} matched with {c2}\") : matches items based on position in the sequence" );
        }
    }
}
